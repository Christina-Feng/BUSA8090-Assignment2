...
# Join hs.exp.tab & hs.ann.tab with \t and output Gene (Table 1, Column 1), function_1 (Table 2, Column 2) and expr_value (Table 1, Column 2)

join -t$'\t' -o '1.1,2.2,1.2' hs.exp.tab hs.ann.tab
